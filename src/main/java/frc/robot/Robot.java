...
public class Robot extends TimedRobot {
  ...
  private final SendableChooser<String> m_autoSelector = new SendableChooser<>();
  ...
  public void autonomousInit() {
    m_autonomousCommand = m_robotContainer.getAutonomousCommand(m_autoSelector.getSelected());
